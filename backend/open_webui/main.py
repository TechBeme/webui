...
async def get_manifest_json():
    if app.state.EXTERNAL_PWA_MANIFEST_URL:
        ...
        return {
            ...
            "description": f"A YuIA é uma plataforma que reúne as melhores ferramentas de inteligência artificial — como ChatGPT, Gemini, Claude, Grok e muito mais — em um só lugar!",
            "start_url": "/",
            "display": "standalone",
